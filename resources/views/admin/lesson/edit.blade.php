        ...
        <div class="card" id="app">
            <div class="card-body">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-profile-tab" href="#">编辑课程</a>
                    </li>
                </ul>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9"><input type="text" id="text-input"
                                                                                    ...
                                                                                    value="{{$lesson['title']}}"></div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3"><label for="text-input"
                                                                                 class=" form-control-label">介绍</label>
                                                </div>
                                                <div class="col-12 col-md-9"><textarea name="introduce"
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="my_radio_box">
                                                        ...
                                                        <div class="my_radio_cell">
                                                            <input type="radio" id="index_1" name="incommend"
                                                                   value="1" {{$lesson['incommend']==1?'checked':''}}>
                                                    ...
                                                    <div class="my_radio_box">
                                                        <span>否</span>
                                                        <div class="my_radio_cell">
                                                            <input type="radio" id="index_2" name="incommend"
                                                                   value="0" {{$lesson['incommend']==0?'checked':''}}>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <div class="my_radio_box">
                                                        <span>是</span>
                                                        <div class="my_radio_cell">
                                                            <input type="radio" id="index_3" name="ishot"
                                                                   value="1" {{$lesson['ishot']==1?'checked':''}}>
                                                    ...
                                                    <div class="my_radio_box">
                                                        <span>否</span>
                                                        <div class="my_radio_cell">
                                                            <input type="radio" id="index_4" name="ishot"
                                                                   value="0" {{$lesson['ishot']==0?'checked':''}}>
